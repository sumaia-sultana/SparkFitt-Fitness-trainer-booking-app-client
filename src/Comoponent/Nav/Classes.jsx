      ...
      <div className="bg-white rounded flex">
        {activeTab === 'trainer' ? (
                ...
                >
                  <div className="flex justify-between">
                    ...
                    <div className="ml-2">
                      ...
                      <div className="mt-2">
                        <button className="rounded-md px-3.5 py-2 m-1 overflow-hidden relative group cursor-pointer border-2 font-medium border-[#6366f1] text-white">
                          <span className="absolute w-64 h-0 transition-all duration-300 origin-center rotate-45 -translate-x-20 bg-[#6366f1] top-1/2 group-hover:h-64 group-hover:-translate-y-32 ease"></span>
                          <span className="relative text-[#6366f1] transition duration-300 group-hover:text-white ease">
          ...
          <div className="p-5">
            ...
            <h1 className="text-2xl text-[#6366f1] font-bold">
