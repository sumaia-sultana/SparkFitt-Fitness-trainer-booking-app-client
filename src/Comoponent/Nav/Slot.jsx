...
const Slot = () => {
  ...
  <h2 className="text-3xl font-bold mb-6 text-[#6366f1] text-center">Available Slots</h2>
        ...
        {slots
          ...
          <tr key={slot._id} className="text-center hover:bg-gray-50">
            ...
            <td className="p-2 border">
              <button className="text-[#6366f1] border border-[#6366f1] px-3 py-1 rounded-sm hover:bg-[#6366f1] hover:text-white transition">
