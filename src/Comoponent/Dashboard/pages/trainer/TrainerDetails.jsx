    ...
    return (
      ...
      <div className="lg:flex mx-auto gap-3 px-10 py-5">
        ...
        <div className="bg-white w-full lg:w-1/3 shadow-md rounded-lg p-6 mb-6 lg:mb-0">
          ...
          />
          <div>
            <h2 className="text-3xl font-bold text-[#064877] mb-2">{trainer.name}</h2>
      ...
      <thead>
      <tr className="bg-[#064877] text-white">
        ...
        <tr key={slot._id} className="hover:bg-gray-100">
          ...
          <td className="py-2 px-1 border text-center">
            <button  onClick={() => handleClick(slot._id)}
              ...
              className="text-white bg-[#064877] px-2 py-2 rounded hover:bg-[#043a5c] text-sm">
              Book Now
            </button>
          </td>
        </tr>
      ...
      <div className="mx-auto p-10 text-center">
        <button className="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-[#064877] transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 group">
          <span className="absolute bottom-0 left-0 w-full h-1 transition-all duration-150 ease-in-out bg-[#064877] group-hover:h-full"></span>
          <span className="absolute right-0 pr-4 duration-200 ease-out group-hover:translate-x-12">
            <svg className="w-5 h-5 text-[#064877]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
          </span>
